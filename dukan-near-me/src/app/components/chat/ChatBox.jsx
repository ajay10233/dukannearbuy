                    ...
                    <div key={index} ref={index === messages.length - 1 ? messagesEndRef : null}>
                      ...
                      {isNewDay && (
                        <div className="flex justify-center my-4">
                          <span className="px-4 py-1 text-xs font-medium text-gray-700 bg-gray-200 rounded-full">
                      ...
                      <div className={`flex ${msg.senderId === session.user.id ? "justify-end" : "justify-start"}`}>
                        <div
                          className={`p-2.5 ${msg.senderId === session.user.id ? "bg-[#D7F8F4]" : "bg-white"}
                        ...
                        >
                          <p className="text-[#010101] opacity-85 font-normal text-sm flex items-center gap-2">
                            {msg.content.startsWith("https://www.google.com/maps") ? (
                              <a
                                href={msg.content}
                                target="_blank"
                              ...
                              >
                                ...
                                <span className="underline text-red-500">Live Location</span>
                              </a>
                            ) : (
                              msg.content
                            )}
