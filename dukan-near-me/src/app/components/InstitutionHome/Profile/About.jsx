            ...
            <div className="flex w-full p-0 pb-6 md:px-8 md:py-2 justify-between items-start">
                <div className="flex flex-col gap-1">
                    <div className="pl-2 md:pl-8 flex flex-col gap-y-1">
                        <p className="text-md text-gray-500">User ID: {userData?.username}</p>
                ...
                <div className="w-full px-0 md:px-8 flex flex-col gap-y-8">
                    <div className="flex flex-col gap-y-2 md:gap-y-3 text-sm md:text-md text-gray-700 border-t pl-2 md:pl-8 pt-4">
                        ...
                        <div className="flex items-start gap-x-2">
                            ...
                            <span className="hover:text-gray-600 transition ease-in-out">{userData?.shopOpenTime || "Not Set"}</span>
                        </div>
                        ...
                        <div className="flex items-start gap-x-2">
                            ...
                            <span className="hover:text-gray-600 transition ease-in-out">{userData?.shopCloseTime || "Not Set"}</span>
                        </div>
                        ...
                        <div className="flex items-start gap-x-2">
                            ...
                            <span className="hover:text-gray-600 transition ease-in-out">
                                {userData?.shopOpenDays?.length
                                    ? formatDayRange(userData.shopOpenDays)
                                    : "Not Set"}
                            </span>
                        </div>
        ...
        {changingAddress && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30">
                ...
                <div className="flex justify-between items-center border-b pb-2 mb-4">
                    <h2 className="text-2xl font-bold text-blue-700">Change Address</h2>
