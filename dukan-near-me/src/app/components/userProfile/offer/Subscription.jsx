    ...
    const fetchPlans = async () => {
      try {
        ...
        if (!data || data.length === 0) {
          console.error("No plans data found.");
          return;
        }
      ...
      <div className="w-full max-w-[1200px] flex flex-col items-center gap-5 md:gap-10">
        ...
        <div className="w-full flex flex-wrap justify-center md:justify-around gap-8">
          {plans.map((plan) => (
            ...
            >
              {/* {plan.image && (
                <Image src={plan.image} alt={plan.name} width={80} height={80} className="rounded-full" />
              )} */}
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-sm text-gray-500">Valid for {plan.durationInDays} days</p>
