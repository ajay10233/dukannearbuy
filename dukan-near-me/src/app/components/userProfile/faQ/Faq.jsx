...
export default function Faq() {
    return (
        <div className="flex flex-col items-center justify-center h-full w-full py-10 gap-y-6">
            <h2 className="text-xl md:text-3xl font-bold text-center">Frequently Asked Questions</h2>
            <div className="w-full max-w-sm md:max-w-4xl bg-white shadow-none md:shadow-md rounded-md py-3 px-6 md:p-6">
                <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="item-1">
                        <AccordionTrigger className="py-2 md:py-4 text-md font-medium cursor-pointer hover:no-underline">
                            What is the inspiration behind this platform?
                        </AccordionTrigger>
                        <AccordionContent className="text-gray-600 overflow-hidden max-h-96 transition-all duration-500 ease-out">
                    ...
                    <AccordionItem value="item-2">
                        <AccordionTrigger className="py-2 md:py-4 text-md font-medium cursor-pointer hover:no-underline">
                            What is the social impact of our partnership?
                        </AccordionTrigger>
                        <AccordionContent className="text-gray-600 overflow-hidden max-h-96 transition-all duration-500 ease-out">
                    ...
                    <AccordionItem value="item-3">
                        <AccordionTrigger className="py-2 md:py-4 text-md font-medium cursor-pointer hover:no-underline">
                            What is the role of the local market in GDP?
                        </AccordionTrigger>
                        <AccordionContent className="text-gray-600 overflow-hidden max-h-96 transition-all duration-500 ease-out">
