...
export default function LoginForm() {
  ...
  return (
    <div className="min-h-screen w-screen flex items-center justify-center bg-[#F1F6F9] relative">

{isLoading && (
  <div className="absolute inset-0 z-10 flex h-full w-full items-center justify-center backdrop-blur-sm bg-white/40">
    <Grid
      visible={true}
      height="80"
      width="80"
